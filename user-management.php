									...
									<div class="panel">
										...
										<div class="panel-content" ng-controller="listMemberCtrl">
											<div>
												...
												<dir-pagination-controls data-boundary-links="true" data-num-pages="noOfPages" data-current-page="currentPage" max-size="maxSize" class="pagination-small" data-previous-text="&laquo;" data-next-text="&raquo;"></dir-pagination-controls>
											</table>
										</div>
									</div>
								</div>
