									...
									<div class="panel">
										...
										<div class="panel-content">
											...
											<form method="post" action="email-settings">
												...
												<option value="email-welcome.php">Welcome (Email Verification)</option>
												<option value="email-forgot.php" selected>Forgot Password Email</option>
											</select>	
											</form>
											
											</p>
												<form class="form-horizontal" method="post" action="data/update-email-content">
													<input type="hidden" name="et" value="forgot_password">
													<fieldset>
													<div class="control-group">
														<label class="control-label" for="">Email Content</label>
														<div class="controls">
														<textarea name="ec" id="editor1" rows="10" cols="80">
																<?php	$email_type = "forgot_password"; get_email_content($email_type);?>
															</textarea>
															<script>
