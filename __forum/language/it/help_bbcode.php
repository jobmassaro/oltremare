...
$help = array(
	...
	array(
		...
		1 => 'Il BBCode del phpBB3 supporta diversi modi per creare URI, Uniform Resource Indicators meglio conosciuti come URL.<ul><li>Il primo di questi utilizza il tag <strong>[url=][/url]</strong>, qualunque cosa digiti dopo il segno = genererà il contenuto del tag che si comporterà come URL. Per esempio per linkarsi a phpBB.com devi usare:<br /><br /><strong>[url=https://www.phpbb.com/]</strong>Visita phpBB!<strong>[/url]</strong><br /><br />Questo genera il seguente link, <a href="https://www.phpbb.com/">Visita phpBB!</a> Come puoi vedere il link si apre in una nuova finestra così l’utente può continuare a navigare nei forum.</li><li>Se vuoi che l’URL stesso venga mostrato come link puoi fare questo semplicemente usando:<br /><br /><strong>[url]</strong>https://www.phpbb.com/<strong>[/url]</strong><br /><br />Questo genera il seguente link, <a href="https://www.phpbb.com/">https://www.phpbb.com/</a></li><li>Inoltre phpBB dispone di una funzione chiamata <i>Magic Links</i>, questo cambierà ogni URL sintatticamente corretto in un link senza la necessità di specificare nessun tag o https://. Per esempio digitando www.phpbb.com nel tuo messaggio automaticamente verrà cambiato in <a href="https://www.phpbb.com/">www.phpbb.com</a> e verrà mostrato nel messaggio finale.</li><li>La stessa cosa accade per gli indirizzi email, puoi specificare un indirizzo esplicitamente, per esempio:<br /><br /><strong>[email]</strong>no.one@domain.adr<strong>[/email]</strong><br /><br />che mostrerà <a href="mailto:no.one@domain.adr">no.one@domain.adr</a> oppure puoi digitare no.one@domain.adr che verrà automaticamente convertito all’interno del tuo messaggio.</li></ul>Come per tutti i tag del BBCode puoi includere URL in ogni altro tag come <strong>[img][/img]</strong> (guarda il punto successivo), <strong>[b][/b]</strong>, ecc. Come per i tag di formattazione dipende da te verificare che tutti i tag siano correttamente aperti e chiusi, per esempio:<br /><br /><strong>[url=https://www.phpbb.com/][img]</strong>https://www.phpbb.com/theme/images/logos/blue/160x52.png<strong>[/url][/img]</strong><br /><br /><span style="text-decoration: underline">non</span> è corretto e potrebbe cancellare il tuo messaggio. Quindi presta attenzione.'
	),
	array(
		0 => '--',
	...
	array(
		...
		1 => 'Il BBCode del phpBB3 incorpora un tag per l’inclusione di immagini nei tuoi messaggi. Ci sono due cose importanti da ricordare nell’usare questo tag: a molti utenti non piacciono molte immagini nei messaggi e in secondo luogo l’immagine deve essere già disponibile su internet (non può esistere solo sul tuo computer per esempio, a meno che tu non abbia un webserver!). Per mostrare delle immagini devi inserire l’URL che rimanda all’immagine con il tag <strong>[img][/img]</strong>. Per esempio:<br /><br /><strong>[img]</strong>https://www.phpbb.com/theme/images/logos/blue/160x52.png<strong>[/img]</strong><br /><br />Puoi inserire un’immagine nel tag <strong>[url][/url]</strong> se vuoi, es.<br /><br /><strong>[url=http://www.google.com/][img]</strong>https://www.phpbb.com/theme/images/logos/blue/160x52.png<strong>[/img][/url]</strong><br /><br />genera:<br /><br /><a href="https://www.phpbb.com/"><img src="https://www.phpbb.com/theme/images/logos/blue/160x52.png" alt="" /></a>'
	),
	array(
