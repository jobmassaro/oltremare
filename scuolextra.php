...
list($meta_title, $meta_description, $site_title, $site_email, $site_logo) = all_settings();
  ...
  $sql = "SELECT * FROM oltremare.cv_scuole_formazione_extra ORDER BY scuola ASC";
  ...
  $arr = array();
    ...
    {  
       ...
       $myfile = fopen("sezione/corsi/extra/extra.json", "w") or die("Unable to open file!");
...
<?php include('assets/comp/top-nav.php');?>
	<div id="wrapper" ng-controller="ExtraCtrl">
		<!-- Side Wrapper -->
        <div id="side-wrapper">
            <ul class="side-nav">
        ...
        <div id="page-content-wrapper">
            <div class="container-fluid">
                          ...
                          <button class="btn btn-sm btn-success" ng-show="show_form" ng-click="addScuolaExtra(details)" id="mainCorso" style="margin-right:20px"><b>Aggiungi Scuuola</b> <span class="glyphicon glyphicon-plus" aria-hidden="true"></span></button>
												</div>
											</span>
										</div>
...
var app = angular.module('extra',['ngMaterial']);
...
<script src="sezione/corsi/extra/extra.js"></script>	
