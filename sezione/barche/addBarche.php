...
$sql = "INSERT INTO cv_barche (id_utente,nome,cognome,armatore,tipo,cantiere,modello,metri) VALUES (" .$id_utente . ",'". $nome . "','". $cognome .  "','" . $armatore 
	."','". $tipo."','". $cantiere."','". $modello ."','" . $metri . "')";
