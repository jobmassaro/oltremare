...
$ccv = mysqli_real_escape_string($mysqli, $data->ccv);
...
"',data_scadenza='" .$data_scadenza. "',ccv='" .$ccv ."' WHERE id=". $id ." AND id_utente=".$id_utente ;
...
/**/
  ...
  $arr = array();
    ...
    {  
       ...
       $myfile = fopen("infobanca.json", "w") or die("Unable to open file!");
       $txt =json_encode($arr);
       fwrite($myfile, $txt);
       fclose($myfile);
     }
