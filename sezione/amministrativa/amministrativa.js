...
app.controller("AmministrazioneCtrl",function($scope, $http){
	...
	{
			$http.post('sezione/amministrativa/updateAmm.php',{"id": info.id, "id_utente":info.id_utente, "banca":info.banca,
				"abi":info.abi,"cab":info.cab,"cin":info.cin,"cc":info.cc,"iban":info.iban,"carta_credito": info.carta_credito,"data_scadenza":info.data_scadenza
