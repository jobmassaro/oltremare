...
<div class="container">
        <div class="row">
                ...
                <form method="post" action="new-installation.php" class="form-horizontal login-form">
                                <fieldset>
                                            <legend>CV.Oltremare</legend>
                                            ...
                                            <div class="control-group">
                                                <label class="control-label" for="textinput">Table Prefix</label>
                                                <div class="controls">
                                                <input id="textinput" name="prefix" type="text" class="input-xlarge" value="cv_">
                                                </div>
                                            </div>
